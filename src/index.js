...
itemLogic.addTask(0, "task00", "des00", "due00", "low", "0", "note00", false);
itemLogic.addTask(0, "task01", "des01", "due01", "low", "0", "note01", false);
itemLogic.addTask(0, "task02", "des01", "due01", "low", "0", "note01", false);
itemLogic.addTask(0, "task03555555555555555555555555555555555555666666666666655555555555555555555555555555555555555555", "des01", "due01", "low", "0", "note01", false);
itemLogic.addTask(0, "task04", "des01", "due01", "medium", "0", "note01", false);
itemLogic.addTask(0, "task05", "des01", "due01", "medium", "0", "note01", false);
itemLogic.addTask(0, "task06", "des01", "due01", "medium", "0", "note01", false);
itemLogic.addTask(0, "task07", "des01", "due01", "medium", "0", "note01", false);
itemLogic.addTask(0, "task08", "des01", "due01", "high", "0", "note01", false);
itemLogic.addTask(0, "task09", "des01", "due01", "high", "0", "note01", false);
itemLogic.addTask(0, "task10", "des01", "due01", "high", "0", "note01", false);


itemLogic.modifyTask(0, 1, "task000", "des000", "due000", "low", "0", "note000");

itemLogic.switchTask(0, 0);
itemLogic.addTask(1, "task10", "des10", "due10", "high", "1", "note10", false);
