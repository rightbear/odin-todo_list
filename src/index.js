...
itemLogic.addTask(0, "task00", "des00", "due00", "pri00", "project1", "note00");
itemLogic.addTask(0, "taske01", "des01", "due01", "pri01", "project1", "note01");

itemLogic.modifyTask(0, 1, "task000", "des000", "due000", "pri000", "project1", "note000");
itemLogic.switchTask(0, 0);
itemLogic.addTask(1, "task10", "des10", "due10", "pri10", "project2", "note10");
